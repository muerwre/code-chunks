...
# 1. Change this:
DIR_TMP="/tmp/"
DIR_WWW="/var/www/deploys/$1"
DIR_GIT="/opt/deploys/git/"
DIR_ENV="/opt/deploys/env/"

# 2. Do "git remote add deploy ssh://user@host.com:port/opt/deploys/git/vault.git" at local machine
# 3. Change "Do stuffs, like npm install" section here to make deploy
# 4. Better write deploy.sh at your project
